...
qq.FileUploaderBasic.prototype = {
    ...
    _uploadFile: function(fileContainer) {
        ...
        if(this._options.onSubmit(id, fileName, this.currentInput) !== false) {
    ...
    _setupDragDrop: function() {
        ...
        var dz = new qq.UploadDropZone({
            ...
            onDrop: function(e) {
                ...
                qq.removeClass(dropArea, self._classes.dropActive);
                if(!self._options.multiple && e.dataTransfer.files.length > 1) alert("Multiple file uploads are disabled.");
                else self._uploadFileList(e.dataTransfer.files);
            }
        });
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _createForm: function(iframe, params) {
        ...
        } else form = qq.toElement('<form method="post" enctype="multipart/form-data"></form>');
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params) {
        ...
        if(token) xhr.setRequestHeader(xname, token);
        xhr.send(file);
    },
