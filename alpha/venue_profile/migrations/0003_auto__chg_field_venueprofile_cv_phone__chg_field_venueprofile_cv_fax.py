...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VenueProfile.cv_phone'
        db.alter_column('venue_profile', 'cv_phone', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'VenueProfile.cv_fax'
        db.alter_column('venue_profile', 'cv_fax', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'VenueProfile.cv_phone'
        db.alter_column('venue_profile', 'cv_phone', self.gf('django.db.models.fields.TextField')())

        # Changing field 'VenueProfile.cv_fax'
        db.alter_column('venue_profile', 'cv_fax', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 5, 3, 2, 6, 584715)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 5, 3, 2, 6, 584119)'}),
