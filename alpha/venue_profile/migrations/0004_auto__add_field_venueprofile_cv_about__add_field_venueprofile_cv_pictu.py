...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VenueProfile.cv_about'
        db.add_column('venue_profile', 'cv_about', self.gf('django.db.models.fields.TextField')(default='Not provided'), keep_default=False)

        # Adding field 'VenueProfile.cv_picture'
        db.add_column('venue_profile', 'cv_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'VenueProfile.cv_cropping'
        db.add_column('venue_profile', 'cv_cropping', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VenueProfile.cv_about'
        db.delete_column('venue_profile', 'cv_about')

        # Deleting field 'VenueProfile.cv_picture'
        db.delete_column('venue_profile', 'cv_picture')

        # Deleting field 'VenueProfile.cv_cropping'
        db.delete_column('venue_profile', 'cv_cropping')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 5, 3, 29, 30, 332776)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 5, 3, 29, 30, 332169)'}),
